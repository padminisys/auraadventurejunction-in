  ...
  if (!hash_equals($_SESSION['csrf_token'], $_POST['csrf_token'])) {
    ...
    if (!$recaptchaData->success) {
      ...
      if (empty($name) || empty($number) || empty($email) || empty($location) || empty($message)) {
        ...
        $mail->isSMTP();
        $mail->Host = getenv('smtp.gmail.com');         // Replace with your SMTP host
        $mail->SMTPAuth = true;
        $mail->Username = getenv('raoanamika34@gmail.com');        // Replace with your SMTP username
        $mail->Password = getenv('sesv lddn hueu ehnj');       // Replace with your SMTP password
        $mail->SMTPSecure = 'tls';
        $mail->Port = 587;                          // Replace with your SMTP port

        $mail->setFrom('raoanamika34@gmail.com', 'anamika');
        $mail->addAddress('raoanamika34@gmail.com', 'Anamika');      // Replace with your email address
...
<head>
  ...
  <!-- trampoline -->
  <meta name="keywords" content="Trampoline park, Indoor entertainment, Family fun locations, Kid-friendly activities, Adventure park, ,SAMALKA, NEW DELHI, India
    ">
  <meta name="description"
    content="Experience unlimited fun and entertainment at Aura adventure junction for  trampoline zones. Best Family friendly location for kids, adults for all ages in ,SAMALKA, NEW DELHI, India.">
  <!-- zorbing ball -->
  <meta name="keywords"
    content="zorbing ball in Samalka New Delhi, zorbing ball suppliers, zorbing ball manufacturers, Aura Adventure Junction, inflatable zorbing balls in New Delhi">
  <meta name="description"
    content="Get inflatable zorbing balls in Samalka, New Delhi at the best price from Aura Adventure Junction. A variety of sizes and high-quality products available.">
  <meta property="og:description"
    content="Get zorbing ball in New Delhi,India at best price. Find list of zorbing ball manufacturers, suppliers located in Samalka &amp; near by cities.">
 
  <meta property="og:description"
    content="Experience unlimited fun and entertainment at Aura adventure junction. Enjoy slam dunk, freestyle jumping, foam pit, and more. Book now!">

  <!-- inflatable mickey mouse -->
  <meta property="og:title" content="Inflatable Mickey">
  <meta property="og:description"
    content="Shop for Inflatable Mickey at Aura Adventure Junction. Save money. Live better">
  <!-- Inflatable Water Roller -->
  <meta property="og:title" content="Inflatable Water Roller at Best Price in India">
  <meta name="Keywords"
    content="Inflatable Water Roller, manufacturers, suppliers, exporters, traders, dealers, manufacturing companies, retailers, producers, Amusement Park Games &amp; Equipment India">
  <!-- Gladiator Duel -->
  <meta property="og:title" content="First Class Castles - Gladiator Duel / Wrestling Inflatable Bouncy Game">
  <meta property="og:description"
    content="Gladiator Wrestling Game, consists of a large inflatable bed with two raised plinths. The aim of the game is to knock your opponent off their plinth with the pugel stick provided. Similar to the game seen on the Gladiator television programme. Book Your Gladiator Inflatable Game hire today!">
  <!-- hot air balloon -->
  <meta property="og:title" content="Hot Air Ballooning in New Delhi">
  <meta name="description"
    content="Experience the thrill of outdoor adventures with Aura Adventure Junction. Try activities like hot air balloon safaris, zorbing, trampolines, and more in New Delhi, India. Don't miss out on these exciting attractions for all ages.">
  <!-- bungee injection -->
  <meta name="description"
    content="Aura Adventure Junction offers thrilling adventure activities in India, including Bungee Jumping in New delhi, hot air balloon rides, zorbing, and more. Book now and enjoy exciting offers . Experience the highest bungee jump and other adventures with Aura Adventure Junction.">
<!-- bowling valley -->
<meta property="og:title" content="ENTERTAINMENT">
<meta property="og:description" content="<p>Get the party going by offering hours of endless fun to your guests with this bowling alley game. Rent it on aura adventure and let the fun begin.</p> ">
...
<body>
  <a target="_blank" href="https://api.whatsapp.com/send?phone=919509924199&text=aura_adventure"
      ...
      <div class="activity_outer_box" data-aos="fade-up">
        <div class="row">
              ...
              <div class="col-lg-12 col-md-6 col-sm-6 col-12">
                <div class="activity_wrapper position-relative">
                  <figure class="activity-image">
                    <img src="assets/images/Products/1_Product_Trampoline/compressed_1726651565997.jpeg" alt="image"
                      class="img-fluid" />
                  </figure>
              ...
              <div class="col-lg-12 col-md-6 col-sm-6 col-12" id="waterrolar">
                <div class="activity_wrapper position-relative">
                  <figure class="activity-image mb-0">
                    <img src="assets/images/Products/2_Product_Inflatable Water roller/compressed_1726651563215.jpeg"
          ...
          <div class="col-lg-6 col-12" id="bodyZorbing">
            <div class="activity_wrapper position-relative">
              <figure class="activity-image mb-0">
                <img src="assets/images/Products/3_Product_Inflatbale Land Zorbing Ball/compressed_1726651562991.jpeg"
                  alt="image" class="img-fluid" />
              </figure>
          ...
          <div class="col-lg-3 col-12">
            <div class="row">
              <div class="col-lg-12 col-md-6 col-sm-6 col-12">
                <div class="activity_wrapper position-relative">
                  <figure class="activity-image">
                    <img src="assets/images/Products/4_Product_Inflatable Gladiator Duel/compressed_1726651564887.jpeg"
                      alt="image" class="img-fluid" />
                  </figure>
              ...
              <div class="col-lg-12 col-md-6 col-sm-6 col-12">
                <div class="activity_wrapper position-relative">
                  <figure class="activity-image mb-0">
                    <img src="assets/images/Products/5_Product_Inflatable Micky Mouse/compressed_1726651565081.jpeg"
                      alt="image" class="img-fluid" />
                  </figure>
      ...
      <div class="activity_outer_box" data-aos="fade-up">
        <div class="row">
            ...
            <div class="row">
              <div class="col-lg-12 col-md-6 col-sm-6 col-12" id="Zorbing">
                <div class="activity_wrapper position-relative">
                  ...
                  <a href="#" class="text-decoration-none" data-toggle="modal" data-target="#blog-model-8">
                    <figure class="activity-plus mb-0">
                      <img src="assets/images/activity3-plusicon.png" alt="image" class="img-fluid" />
                    </figure>
                  </a>
              ...
              <div class="col-lg-12 col-md-6 col-sm-6 col-12">
                <div class="activity_wrapper position-relative">
                  <figure class="activity-image mb-0">
                    <img src="assets/images/Products/7_Product_ Inflatable Balling Alley/compressed_1726651559579.jpeg"
                      alt="image" class="img-fluid" />
                  </figure>
                  <a href="#" class="text-decoration-none" data-toggle="modal" data-target="#blog-model-7">
                    <figure class="activity-plus mb-0">
                      <img src="assets/images/activity3-plusicon.png" alt="image" class="img-fluid" />
                    </figure>
                  </a>
          ...
          <div class="col-lg-6 col-12">
            <div class="activity_wrapper position-relative">
              <figure class="activity-image mb-0">
                <img src="assets/images/Products/10_Product_Bungee Injection/compressed_1726651568202.jpeg" alt="image"
                  class="img-fluid" />
              </figure>
              <a href="#" class="text-decoration-none" data-toggle="modal" data-target="#blog-model-10">
                <figure class="activity-plus mb-0">
                  <img src="assets/images/activity3-plusicon.png" alt="image" class="img-fluid" />
                </figure>
              </a>
          ...
          <div class="col-lg-3 col-12">
            <div class="row">
              <div class="col-lg-12 col-md-6 col-sm-6 col-12">
                <div class="activity_wrapper position-relative">
                  <figure class="activity-image">
                    <img src="assets/images/Products/9_Product_Human Sling Shoot/compressed_1726651560135.jpeg"
                      alt="image" class="img-fluid" />
                  </figure>
                  <a href="#" class="text-decoration-none" data-toggle="modal" data-target="#blog-model-9">
                    <figure class="activity-plus mb-0">
                      <img src="assets/images/activity3-plusicon.png" alt="image" class="img-fluid" />
                    </figure>
                  </a>
              ...
              <div class="col-lg-12 col-md-6 col-sm-6 col-12">
                <div class="activity_wrapper position-relative">
                  <figure class="activity-image">
                    <img src="assets/images/Products/6_Product_Hot Air Balloon/compressed_1726651561945.jpeg"
                      alt="image" class="img-fluid" />
                  </figure>
              ...
              <div class="col-lg-3 col-md-3 col-sm-4 col-6">
                <div class="links">
                  ...
                  <ul class="list-unstyled mb-0">
                    <li>
                      <i class="fa-solid fa-circle"></i><a href="#" class="text-decoration-none">Home</a>
                    </li>
                    <li>
                      <i class="fa-solid fa-circle"></i><a href="#" class="text-decoration-none">About</a>
                    </li>
                    <li>
                      <i class="fa-solid fa-circle"></i><a href="#" class="text-decoration-none">Services</a>
                    </li>
                    <li>
                      <i class="fa-solid fa-circle"></i><a href="#" class="text-decoration-none">Blog</a>
                    </li>
                    <li>
                      <i class="fa-solid fa-circle"></i><a href="#" class="text-decoration-none">Contact Us</a>
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div class="contact">
                  ...
                  <ul class="list-unstyled mb-0">
                    ...
                    <li class="text">
                      ...
                      <a href="mailto:auraadventure82@gmail.com"
                        class="text-decoration-none">auraadventure82@gmail.com</a>
                    </li>
                    <li class="text">
              ...
              <div class="col-lg-3 col-md-3 col-sm-4 col-6">
                <div class="icon">
                  ...
                  <ul class="list-unstyled mb-0 social-icons">
                    <li>
                      <a href="https://www.facebook.com/profile.php?id=61564764900354&mibextid=ZbWKwL"
                        class="text-decoration-none"><i class="fa-brands fa-facebook-f social-networks"
                          aria-hidden="true"></i></a>
                    </li>
                    <li>
                      <a href="https://x.com/aura_adventure?t=vnor0jHpLWL81xzB7ult-g&s=09"
                        class="text-decoration-none"><i class="fa-brands fa-x-twitter social-networks"
                          aria-hidden="true"></i></a>
                    </li>
                    <li>
                      <a href="https://youtube.com/@auraadventurejunction_in?si=I97Q9Y2tihNwPJxS"
                        class="text-decoration-none"><i class="fa-brands fa-youtube social-networks"
                          aria-hidden="true"></i></a>
                    </li>
                    <li>
                      <a href="https://www.instagram.com/auraadventurejunctionllp?igsh=cnlmNnlzOWc4eTN4"
                        class="text-decoration-none"><i class="fa-brands fa-instagram social-networks"
                          aria-hidden="true"></i></a>
                    </li>
                  </ul>
                  <br />
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="blog-box-item mb-0">
              <div class="blog-img">
                <figure class="mb-0">
                  <img src="assets/images/Products/1_Product_Trampoline/compressed_1726651565997.jpeg" alt="blog-img"
                    class="img-fluid" />
                </figure>
              </div>
              <div class="blog-img">
                <figure class="mb-0">
                  <img src="assets/images/Products/1_Product_Trampoline/compressed_1726651564523.jpeg" alt="blog-img"
                    class="img-fluid" />
                </figure>
              </div>
              <div class="project_content">
                <h3>TRAMPOLINE</h3>
                <span class="text">A trampoline is a spring-based or elastic device used for
                ...
                <span class="text">SIZE:- Our trampolines, available in 10, 12, 14, and 16
                  ...
                  all ages.</span>
                <a href="#" data-toggle="modal" data-target="#myModal" class="text-decoration-none all_button">Enquiry
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="blog-box-item mb-0">
              <div class="blog-img">
                <figure class="mb-0">
                  <img src="assets/images/Products/2_Product_Inflatable Water roller/compressed_1726651564763.jpeg"
              ...
              <div class="project_content">
                <h3>WATER ROLLER</h3>
                <span class="text">An inflatable water roller is a large, cylindrical,
                ...
                <span class="text">SIZE:- Inflatable water rollers typically range in size
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="blog-box-item mb-0">
              <div class="blog-img">
                <figure class="mb-0">
                  <img src="assets/images/Products/3_Product_Inflatbale Land Zorbing Ball/compressed_1726651565836.jpeg"
                    alt="blog-img" class="img-fluid" />
                </figure>
              </div>
              <div class="blog-img">
              ...
              <div class="project_content">
                ...
                <span class="text">A land zorbing ball is a large, transparent inflatable
                ...
                <span class="text">SIZE:- zorbing balls typically range in size from 2.5 to
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="blog-box-item mb-0">
              <div class="blog-img">
                <figure class="mb-0">
                  <img src="assets/images/Products/4_Product_Inflatable Gladiator Duel/compressed_1726651561620.jpeg"
                    alt="blog-img" class="img-fluid" />
                </figure>
              </div>
              <div class="blog-img">
              ...
              <div class="project_content">
                ...
                <span class="text">An inflatable gladiator duel is a fun, safe activity where
                ...
                <span class="text">SIZE:- The size of an inflatable gladiator duel typically
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="blog-box-item mb-0">
              <div class="blog-img">
                <figure class="mb-0">
                  <img src="assets/images/Products/5_Product_Inflatable Micky Mouse/compressed_1726651560861.jpeg"
                    alt="blog-img" class="img-fluid" />
                </figure>
              </div>
              <div class="blog-img">
              ...
              <div class="project_content">
                ...
                <span class="text">An inflatable Mickey Mouse is a large, air-filled structure
                ...
                <span class="text">SIZE:-The size of an inflatable Mickey Mouse can vary
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="blog-box-item mb-0">
              ...
              <div class="blog-img">
                <figure class="mb-0">
                  <img src="assets/images/Products/6_Product_Hot Air Balloon/compressed_1726651565421.jpeg"
                    alt="blog-img" class="img-fluid" />
                </figure>
              </div>
              <div class="project_content">
                <h3>HOT AIR BALLOON</h3>
                <span class="text">A hot air balloon consists of a large fabric envelope
                ...
                <span class="text">SIZE:- 2 SIZE SUCH 105,180. Hot air balloons vary in size,
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="blog-box-item mb-0">
              ...
              <div class="blog-img">
                <figure class="mb-0">
                  <img src="assets/images/Products/7_Product_ Inflatable Balling Alley/compressed_1726651558056.jpeg"
                    alt="blog-img" class="img-fluid" />
                </figure>
              </div>
              <div class="project_content">
                <h3>INFLATABLE BALLING ALLEY</h3>
                <span class="text">An inflatable balling alley features a soft, cushioned
                ...
                <span class="text">SIZE:- An inflatable bowling alley typically measures
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="blog-box-item mb-0">
              <div class="blog-img">
                <figure class="mb-0">
                  <img src="assets/images/Products/8_Product_Inflatable Body Zorbing Ball/compressed_1726651561532.jpeg"
                    alt="blog-img" class="img-fluid" />
                </figure>
              </div>
              <div class="blog-img">
                <figure class="mb-0">
                  <img src="assets/images/Products/8_Product_Inflatable Body Zorbing Ball/IMG-20240827-WA0041.jpg"
                    alt="blog-img" class="img-fluid" />
                </figure>
              </div>
              <div class="project_content">
                <h3>INFLATABLE BODY ZORB BALL</h3>
                <span class="text">An inflatable body zorb ball is a large, transparent,
                ...
                <span class="text">SIZE:- Inflatable body zorb balls typically range from 2.5
  ...
  <div class="project_modal">
    <div id="blog-model-9" class="modal fade blog-model-con" tabindex="-1" style="display: none" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close">
          ...
          <div class="modal-body">
            <div class="blog-box-item mb-0">
              ...
              <div class="blog-img">
                <figure class="mb-0">
                  <img src="assets/images/Products/9_Product_Human Sling Shoot/compressed_1726651567352.jpeg"
                    alt="blog-img" class="img-fluid" />
                </figure>
              </div>
              <div class="project_content">
                <h3>HUMAN SLING SHOOT</h3>
                <span class="text">A human slingshot is an exhilarating activity where
                ...
                <span class="text">SIZE:- A human slingshot setup typically involves a launch
  ...
  <div class="project_modal">
    <div id="blog-model-10" class="modal fade blog-model-con" tabindex="-1" style="display: none" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close">
          ...
          <div class="modal-body">
            <div class="blog-box-item mb-0">
              <div class="blog-img">
                <figure class="mb-0">
                  <img src="assets/images/Products/10_Product_Bungee Injection/compressed_1726651568202.jpeg"
                    alt="blog-img" class="img-fluid" />
                </figure>
              </div>
              <div class="blog-img">
                <figure class="mb-0">
                  <img src="assets/images/Products/10_Product_Bungee Injection/compressed_1726651558944.jpeg"
                    alt="blog-img" class="img-fluid" />
                </figure>
              </div>
              <div class="project_content">
                <h3>BUNGEE INJECTION</h3>
                <span class="text">Bungee injection, commonly known as bungee jumping,
                ...
                <span class="text">SIZE:- The size of the bungee cord varies dependin on the
          ...
          <div class="modal-content clearfix">
            ...
            <div class="modal-body" style="border: 4px solid #11bef1; border-radius: 15px;">
              ...
              <form id="enquiryForm" method="post" action="products.php">
                ...
                <div class="g-recaptcha" data-sitekey="<?php echo htmlspecialchars($dataSiteKey); ?>"></div>
